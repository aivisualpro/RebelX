...
function SalesOfficersContent() {
  ...
  // Load sales officers data
  useEffect(() => {
    const loadSalesOfficers = async () => {
      try {
        const companyId = searchParams.get('companyId') || 'booking-plus';
        ...
        if (data.users) {
          ...
          setUsers(salesOfficers);
        }
      } catch (error) {
        console.error('Error loading sales officers data:', error);
      }
    };
  ...
  if (appStateLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-lg text-gray-600">Loading sales officers...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <header className="bg-white/80 backdrop-blur border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <span className="text-slate-700 font-medium">Sales Officers</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-slate-900 mb-2">Sales Officers</h1>
          <p className="text-slate-600">Detailed view of all sales officers</p>
        </div>
